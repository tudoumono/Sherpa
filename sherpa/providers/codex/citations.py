"""Codex 原本直読の出典化（提案書 2026-09-10-Codex原本直読と調査スキル.md §2-5・S2）。

S1（原本直読サンドボックス拡張）で Codex が原本（Excel/Word/PowerPoint/PDF・テキスト・コード）を
コードインタープリターで直接開けるようになったため、直読した資料は MCP ツールの戻り値に載らず
