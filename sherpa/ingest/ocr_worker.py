...
_PADDLE_SUFFIX_BY_MEDIA_TYPE = {
    ...
    "image/x-portable-anymap": ".pnm", "image/x-cmu-raster": ".ras", "application/pdf": ".pdf",
}


def _paddle_input_suffix(media_type: str) -> str:
    return _PADDLE_SUFFIX_BY_MEDIA_TYPE.get((media_type or "").split(";")[0].strip().lower(), ".png")
...
class PaddleOCREngine:
    ...
    def predict(self, image_bytes: bytes, *, media_type: str) -> OCRPrediction:
        suffix = _paddle_input_suffix(media_type)
